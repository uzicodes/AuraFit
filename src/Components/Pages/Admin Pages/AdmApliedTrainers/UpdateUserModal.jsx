...
const UpdateUserModal = ({ setIsOpen, isOpen, modalHandler, appTrainer }) => {
  const [selected, setSelected] = useState(appTrainer.role);
  return (
            ...
            >
              <DialogPanel className="w-full h-56 max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="flex mt-2 justify-center gap-5">
                  <button
                    type="button"
                    className="inline-flex bg-[#21BDCE]  justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white hover:bg-[#198E9A] focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2"
                  ...
                  <button
                    type="button"
                    className="inline-flex justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2"
